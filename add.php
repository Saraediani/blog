        ...
        <div class="container">
            <div class="row">
                <div class="col-12 bg-white border rounded shadow-lg p-4 mb-5">
                    <div class="row mb-3">
                        <div class="col"><span class="h2">Add Article</span></div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="./controllers/add.php" method="post">
                                ...
                                <div class="form-group">
                                    <textarea style="min-height:350px;" name="body" id="body" class="form-control summernote" placeholder="Content..."></textarea>
                                </div>
                                <div class="form-group">
